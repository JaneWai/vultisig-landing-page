        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
            <div className="col-span-2 lg:col-span-1">
              <h3 className="text-xl font-bold text-white mb-4">Vultisig</h3>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-indigo-100 hover:text-white transition-colors">Documentation</a></li>
                <li><a href="#" className="text-indigo-100 hover:text-white transition-colors">API</a></li>
                <li><a href="#" className="text-indigo-100 hover:text-white transition-colors">Guides</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-indigo-100 hover:text-white transition-colors">Blog</a></li>
                <li><a href="#" className="text-indigo-100 hover:text-white transition-colors">Careers</a></li>
                <li><a href="#" className="text-indigo-100 hover:text-white transition-colors">Contact</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-indigo-100 hover:text-white transition-colors">Cookie Policy</a></li>
                <li><a href="#" className="text-indigo-100 hover:text-white transition-colors">Security</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-white border-opacity-10 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex space-x-6">
              <a href="#" className="text-indigo-100 hover:text-white transition-colors">Privacy</a>
              <a href="#" className="text-indigo-100 hover:text-white transition-colors">Terms</a>
              <a href="#" className="text-indigo-100 hover:text-white transition-colors">Cookies</a>
            </div>
          </div>
        </div>
      </footer>
